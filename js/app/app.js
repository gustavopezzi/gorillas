define(
	...
	function (Wind, Sun, Building, Gorilla) {
		...
		App.prototype.updateScore = function () {
			...
			this.context.fillRect(this.width / 2 - 45, this.height - 40, 90, 20);
			this.context.fillStyle = 'rgb(255, 255, 255)';
			this.context.fillText(this.scores.player_1 + '>Score<' + this.scores.player_2, this.width / 2 - 38, this.height - 26);
		};
		...
		App.prototype.animateColission = function (player) {
			...
			this.timeout = setTimeout(function () {
				...
				if (player.explosionWidth < player.width) {
					that.animateColission(player);
				}
			}, 0);
		};
